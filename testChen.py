...
data[['Edad','Sexo','Estatura','Peso','IMC','CC','PA Sistolica','PA Diastolica',
      'HbA1c','Colesterol Total','Colesterol LDL','Colesterol HDL',
      'Trigliceridos']] = data[['Edad','Sexo','Estatura','Peso','IMC',
      'CC','PA Sistolica','PA Diastolica','HbA1c','Colesterol Total',
      'Colesterol LDL','Colesterol HDL','Trigliceridos']].replace(" ",np.NaN)
data[['Edad','Sexo','Estatura','Peso','IMC','CC','PA Sistolica','PA Diastolica',
      'HbA1c','Colesterol Total', 'Colesterol LDL','Colesterol HDL',
      'Trigliceridos']] = data[['Edad','Sexo','Estatura','Peso','IMC',
      'CC','PA Sistolica','PA Diastolica','HbA1c','Colesterol Total',
      'Colesterol LDL','Colesterol HDL','Trigliceridos']].replace("0",np.NaN)
print(data.isnull().sum())
## Limpieza de Missing Values Para Chen
missing=['Estatura','CC','PA Sistolica','PA Diastolica','Colesterol Total',
         'Colesterol LDL','Colesterol HDL','Trigliceridos'] #Datos Faltantes
for miss in missing:
...
# if (ejecutar=="y"):
#     scaled_data = minmax_scaling(data,columns=['Edad','Sexo','Estatura','Peso',
#                                 'IMC','CC','PA Sistolica','PA Diastolica',
#                                 'HbA1c','Colesterol Total','Colesterol LDL',
